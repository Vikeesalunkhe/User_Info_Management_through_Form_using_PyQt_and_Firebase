# This script defines a PyQt5-based GUI application for displaying userinformation records.
# It includes a C2W_Info class that fetches records from a Firestore databaseand displays them.
